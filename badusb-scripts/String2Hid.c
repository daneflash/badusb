...
static struct key_t keys_special_de[] = {
	{.k = '!', .c = 0x1e, .mod=0x20},
	{.k = '"', .c = 0x1f, .mod=0x20},
	{.k = '§', .c = 0x20, .mod=0x20},
	{.k = '$', .c = 0x21, .mod=0x20},
	...
	for (ic = 0; ic < input_length; ic++) {
		...
		if (lower >= 'a' && lower <= 'z') {
			...
			if(lang == 0){
                ...
                for (i = 0; i < sizeof(keys_special_de); i++) {
                    if (input == keys_special_de[i].k) {
                        if (keys_special_de[i].c != 0) {
                            report[index] = keys_special_de[i].c;
                        }
                        report[0] |= keys_special_de[i].mod;
                        index++;
                        break;
                    }
                    if (keys_special_de[i].k == 0)
                        break;
                }
			}
